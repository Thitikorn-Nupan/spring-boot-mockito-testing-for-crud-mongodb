...
public class RequestClient {
    ...
    private final String[] POST = {baseUrl + "/api/em/create"};
    private final String[] PUT = {baseUrl + "/api/em/update/{id}"};
    private final String[] GET = {baseUrl + "/api/em/reads"};
    private final String[] DELETE = {baseUrl + "/api/em/delete/{id}"};
    ...
    public static void main(String[] args) {
        ...
        requestClient.readsEmployee();
        requestClient.createEmployee();
        requestClient.updateEmployee();
        requestClient.deleteEmployee();
    }
}
